 ...
 */
- (nullable ObjectType) drawAtRandom;
...
/**
 ...
 @returns An NSArray of TTEntity objects.
 */
- (nonnull NSArray<__kindof ObjectType> *) drawFromTopUntil: (nonnull TTEntityConditional) condition inclusive: (BOOL) inclusive;
/**
...
/**
 ...
 @returns An NSArray of TTEntity objects.
 */
- (nonnull NSArray<__kindof ObjectType> *) drawFromBottomUntil: (nonnull TTEntityConditional) condition inclusive: (BOOL) inclusive;
/**
 ...
 */
- (nonnull NSArray<__kindof ObjectType> *) drawAtRandom: (NSUInteger) amount;
